...
exports.bochilteamfb = bochilteamfb;
...
async function bochilteamfb(url_media) {
  try {
    const html = await (0, _got.default)("https://fdownloader.net/en", {
      headers: {
        ...DEFAULT_HEADERS
      }
    }).text();
    ...
    const data = await _got.default.post(k_url_search, {
      headers: {
        ...DEFAULT_HEADERS,
    ...
    const $ = _cheerio.default.load(data.data);
